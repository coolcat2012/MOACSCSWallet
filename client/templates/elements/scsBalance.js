...
Template['elements_scs_balance'].onCreated(function(){
    this._intervalId = null;
});


Template['elements_scs_balance'].helpers({
    /**
    ...
    'getBalance': function(){
        ...
        template._intervalId = Meteor.setInterval(function(){
            var oldBalance = TemplateVar.get(template, 'balance') || 0,
                calcBalanceTmp1 = newBalance.minus(oldBalance),
		tmp2 = calcBalanceTmp1.dividedBy(10),
		calcBalance = tmp2.floor();
