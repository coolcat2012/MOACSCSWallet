...
Template['elements_scs_account'].rendered = function(){
...
Template['elements_scs_account'].helpers({
    /**
    ...
    */
    'account': function(){
        return ScsAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account) || MicroChainContracts.findOne(this.account);
    },
    /**
    Get all tokens
...
Template['elements_scs_account'].events({
    /**
