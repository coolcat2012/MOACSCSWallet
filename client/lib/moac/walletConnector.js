...
connectToNode = function(){
	...
	var vnode = chain3.vnode.address;
	if( vnode ){
		Session.set('vnode', vnode);
	}
	...
	console.log('connect vnode:'+vnode);
	console.log('connect session:'+Session.get('vnode'));
