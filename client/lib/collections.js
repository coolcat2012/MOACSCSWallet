...
ScsPendingConfirmations = new Mongo.Collection('scs-pending-confirmations', {connection: null});
new PersistentMinimongo2(ScsPendingConfirmations, 'moac_wallet');

ScsTransactions = new Mongo.Collection('scs-transactions', {connection: null});
new PersistentMinimongo2(ScsTransactions, 'moac_wallet');

SubChains = new Mongo.Collection('subChains', {connection: null});
new PersistentMinimongo2(SubChains, 'moac_wallet');

ScsBlocks = new Mongo.Collection('scsBlocks', {connection: null});
//new PersistentMinimongo2(ScsBlocks, 'moac_wallet');
ScsAccounts = new Mongo.Collection('scsAccounts', {connection: null});
